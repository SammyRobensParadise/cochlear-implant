...
% create array for center frequencies signals for each sound interval
freq_interval_centers = cell(interval_number,1)
...
for c = 1:indexer
    ...
    freq_interval_centers{c}=get_center_frequency(frequencies(c),frequencies(c+1));
interv_cells=freq_interval_cells;
center_frequencies=freq_interval_centers;
end
